...
email.utils.localtime(dt=None)
   ...
   this case, a positive or zero value for _isdst_ causes "localtime"
   ...
   A negative value for _isdst_ causes the "localtime" to attempt to
...
email.utils.parseaddr(address, *, strict=True)
   ...
   Changed in version 3.11.10: Add _strict_ optional parameter and
