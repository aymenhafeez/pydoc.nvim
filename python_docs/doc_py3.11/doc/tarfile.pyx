...
TarFile.extractall(path='.', members=None, *, numeric_owner=False, filter=None)
   ...
   The _filter_ argument, which was added in Python 3.11.4, specifies
   ...
   Changed in version 3.11.4: Added the _filter_ parameter.
...
tarfile.data_filter(member, path)
   ...
   * Set user and group info ("uid", "gid", "uname", "gname") to
   ...
   Changed in version 3.11.13: Link targets are now normalized.
