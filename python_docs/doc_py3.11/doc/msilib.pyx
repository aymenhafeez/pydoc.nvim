...
"msilib" module is deprecated (see **PEP 594** for details).
...
".msi" file, therefore, it is a fairly low-level API. One primary
application of this package is the creation of Python installer
package itself (although that currently uses a different version of
"msilib").
