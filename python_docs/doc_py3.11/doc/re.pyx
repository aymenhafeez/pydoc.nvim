...
"(?P<name>...)"
   ...
   Deprecated since version 3.11: Group _name_ containing characters
...
"(?(id/name)yes-pattern|no-pattern)"
   ...
   Deprecated since version 3.11: Group _id_ containing anything
   except ASCII digits. Group _name_ containing characters outside the
