...
math.factorial(n)
   ...
   Return _n_ factorial as an integer.  Raises "ValueError" if _n_ is
...
math.nextafter(x, y)
   ...
   Return the next floating-point value after _x_ towards _y_.

   If _x_ is equal to _y_, return _y_.
