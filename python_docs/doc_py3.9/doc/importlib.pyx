...
class importlib.abc.MetaPathFinder
   ...
   An abstract base class representing a _meta path finder_. For
...
importlib.resources.is_resource(package, name)
   ...
   otherwise "False".  Remember that directories are _not_ resources!
   _package_ is either a name or a module object which conforms to the
   "Package" requirements.
...
class importlib.machinery.ModuleSpec(name, loader, *, origin=None, loader_state=None, is_package=None)
   ...
   The _Loader_ that should be used when loading the module.
   _Finders_ should always set this.
