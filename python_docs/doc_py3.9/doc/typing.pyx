...
class typing.Set(set, MutableSet[T])
   ...
   Deprecated since version 3.9: "builtins.set" now supports "[]". See
...
class typing.ContextManager(Generic[T_co])
   ...
   now supports "[]". See **PEP 585** and Generic Alias Type.
...
class typing.AsyncContextManager(Generic[T_co])
   ...
   "contextlib.AbstractAsyncContextManager" now supports "[]". See
   **PEP 585** and Generic Alias Type.
...
typing.get_origin(tp)
   ...
   class. If "X" is a "Union" or "Literal" contained in another
