...
marshalled and unmarshalled. For format _version_ lower than 3,
...
marshal.load(file)
   ...
   "TypeError".  The file must be a readable _binary file_.
   ...
   Changed in version 3.9.7: This call used to raise a "code.__new__"
