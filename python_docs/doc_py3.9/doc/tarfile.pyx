...
TarFile.extractall(path=".", members=None, *, numeric_owner=False, filter=None)
   ...
   The _filter_ argument, which was added in Python 3.9.17, specifies
   ...
   Changed in version 3.9.17: Added the _filter_ parameter.
...
Changed in version 3.9.17: Added "replace()" and handling of "None".
...
TarInfo.mtime: int | float
   ...
   Changed in version 3.9.17: Can be set to "None" for "extract()" and
...
tarfile.data_filter(/, member, path)
   ...
   * Set user and group info ("uid", "gid", "uname", "gname") to
   ...
   Changed in version 3.9.25 (unreleased): Link targets are now
   normalized.
