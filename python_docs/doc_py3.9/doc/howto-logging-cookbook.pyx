...
Supervisor: you will need to change the _/path/to/_ parts in the Gist
...
a class such as _UTCFormatter_, shown below:
>
   import logging
   import time
...
* An attempt to delete a file (e.g. during file rotation) silently
  ...
  unexpected places, or are lost altogether.
