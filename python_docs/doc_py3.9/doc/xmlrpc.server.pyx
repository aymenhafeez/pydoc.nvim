Python 3.9.25
*xmlrpc.server.pyx*                           Last change: 2025 Dec 20
...
class xmlrpc.server.SimpleXMLRPCServer(addr, requestHandler=SimpleXMLRPCRequestHandler, logRequests=True, allow_none=False, encoding=None, bind_and_activate=True, use_builtin_types=False)
   ...
   "SimpleXMLRPCRequestHandler".  The _addr_ and _requestHandler_
   ...
   _allow_none_ and _encoding_ parameters are passed on to
   ...
   variable before the address is bound. The _use_builtin_types_
...
class xmlrpc.server.CGIXMLRPCRequestHandler(allow_none=False, encoding=None, use_builtin_types=False)
   ...
   be returned from the server. The _use_builtin_types_ parameter is
...
class xmlrpc.server.SimpleXMLRPCRequestHandler
   ...
   _logRequests_ parameter to the "SimpleXMLRPCServer" constructor
...
SimpleXMLRPCServer.register_function(function=None, name=None)
   ...
   _function_, otherwise "function.__name__" will be used.  _name_ is
   ...
   decorator, _name_ can only be given as a keyword argument to
   register _function_ under _name_.  If no _name_ is given,
...
SimpleXMLRPCServer.register_instance(instance, allow_dotted_names=False)
   ...
   not been registered using "register_function()".  If _instance_
   ...
   _dispatch(self, method, params)" (note that _params_ does not
   ...
   Warning:
     ...
     Enabling the _allow_dotted_names_ option allows intruders to
...
Warning:
  ...
  Enabling the _allow_dotted_names_ option allows intruders to access
...
CGIXMLRPCRequestHandler.handle_request(request_text=None)
   ...
   Handle an XML-RPC request. If _request_text_ is given, it should be
...
class xmlrpc.server.DocXMLRPCServer(addr, requestHandler=DocXMLRPCRequestHandler, logRequests=True, allow_none=False, encoding=None, bind_and_activate=True, use_builtin_types=True)
   ...
   as for "SimpleXMLRPCServer"; _requestHandler_ defaults to
...
class xmlrpc.server.DocXMLRPCRequestHandler
   ...
   modifies logging so that the _logRequests_ parameter to the
