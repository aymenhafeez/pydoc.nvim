...
statistics.harmonic_mean(data)
   ...
   data. For example, the harmonic mean of three values _a_, _b_ and
   _c_ will be equivalent to "3/(1/a + 1/b + 1/c)".  If one of the
...
>
      ...
      3.6
<
   "StatisticsError" is raised if _data_ is empty, or any element is
   less than zero.
...
class statistics.NormalDist(mu=0.0, sigma=1.0)
   ...
   pdf(x)
      ...
      relative to other points, its value can be greater than _1.0_.
