Python 3.8.20
*binascii.pyx*                                Last change: 2025 Dec 20
...
binascii.crc32(data[, value])
   ...
   Compute CRC-32, the 32-bit checksum of _data_, starting with an
   initial CRC of _value_.  The default initial CRC is zero.  The
