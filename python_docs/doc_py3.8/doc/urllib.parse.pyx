...
urllib.parse.parse_qs(qs, keep_blank_values=False, strict_parsing=False, encoding='utf-8', errors='replace', max_num_fields=None, separator='&')
   ...
   Changed in version 3.8.8: Added _separator_ parameter with the
...
<
   ...
   Changed in version 3.8.17: Leading WHATWG C0 control and space
...
urllib.parse.urljoin(base, url, allow_fragments=True)
   ...
   Note:
     ...
     If _url_ is an absolute URL (that is, starting with "//" or
     "scheme://"), the _url_’s host name and/or scheme will be present
...
urllib.parse.quote(string, safe='/', encoding=None, errors=None)
   ...
   URL. The optional _safe_ parameter specifies additional ASCII
   characters that should not be quoted — its default value is "'/'".

   _string_ may be either a "str" or a "bytes".
...
urllib.parse.quote_plus(string, safe='', encoding=None, errors=None)
   ...
   they are included in _safe_.  It also does not have _safe_ default
   to "'/'".
...
urllib.parse.urlencode(query, doseq=False, safe='', encoding=None, errors=None, quote_via=quote_plus)
   ...
   that case, if the optional parameter _doseq_ is evaluates to
