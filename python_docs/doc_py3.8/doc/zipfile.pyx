...
<
   ...
   New in version 3.8: The _strict_timestamps_ keyword-only argument
...
ZipFile.extractall(path=None, members=None, pwd=None)
   ...
   "namelist()".  _pwd_ is the password used for encrypted files.
...
class zipfile.PyZipFile(file, mode='r', compression=ZIP_STORED, allowZip64=True, optimize=-1)
   ...
   New in version 3.2: The _optimize_ parameter.
...
<
      New in version 3.4: The _filterfunc_ parameter.
