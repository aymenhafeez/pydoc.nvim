...
classmethod date.fromisoformat(date_string)
   ...
   Return a "date" corresponding to a _date_string_ given in the
   format "YYYY-MM-DD":
>
...
classmethod datetime.fromisoformat(date_string)
   ...
   Return a "datetime" corresponding to a _date_string_ in one of the
...
<
   ...
   Caution:
     ...
     This does _not_ support parsing arbitrary ISO 8601 strings - it
...
classmethod time.fromisoformat(time_string)
   ...
   Return a "time" corresponding to a _time_string_ in one of the
...
<
   Caution:
     ...
     This does _not_ support parsing arbitrary ISO 8601 strings. It is
...
See also:
  ...
  dateutil.tz
     ...
     _dateutil.tz_ library brings the _IANA timezone database_ (also
...
timezone.tzname(dt)
   ...
   is now plain _‘UTC’_, not "'UTC+00:00'".
