...
ctypes.WINFUNCTYPE(restype, *argtypes, use_errno=False, use_last_error=False)
   ...
   will release the GIL during the call.  _use_errno_ and
   _use_last_error_ have the same meaning as above.
...
ctypes.GetLastError()
   ...
   calling thread. This function calls the Windows _GetLastError()_
