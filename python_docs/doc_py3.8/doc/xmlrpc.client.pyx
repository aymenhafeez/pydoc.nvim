...
class xmlrpc.client.ServerProxy(uri, transport=None, encoding=None, verbose=False, allow_none=False, use_datetime=False, use_builtin_types=False, *, headers=(), context=None)
   ...
   instance. If _allow_none_ is true,  the Python constant "None" will
   ...
   The _use_builtin_types_ flag can be used to cause date/time values
   ...
   2-tuples representing the header name and value. (e.g. _[(‘Header-
   Name’, ‘value’)]_). The obsolete _use_datetime_ flag is similar to
...
_context manager_ protocol for closing the underlying transport.
...
class xmlrpc.client.MultiCall(server)
   ...
   _generator_; iterating over this generator yields the individual
   results.
...
xmlrpc.client.dumps(params, methodname=None, methodresponse=None, encoding=None, allow_none=False)
   ...
   meaning that _params_ must be of length 1. _encoding_, if supplied,
   ...
   using it via an extension,  provide a true value for _allow_none_.
...
xmlrpc.client.loads(data, use_datetime=False, use_builtin_types=False)
   ...
   _use_builtin_types_ flag can be used to cause date/time values to
   be presented as "datetime.datetime" objects and binary data to be
   presented as "bytes" objects; this flag is false by default.

   The obsolete _use_datetime_ flag is similar to _use_builtin_types_
