Python 3.8.20
*pty.pyx*                                     Last change: 2025 Dec 20
...
pty.spawn(argv[, master_read[, stdin_read]])
   ...
   If both callbacks signal EOF then _spawn_ will probably never
   return, unless _select_ throws an error on your platform when
