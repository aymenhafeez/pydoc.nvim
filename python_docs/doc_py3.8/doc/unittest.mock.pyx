...
class unittest.mock.Mock(spec=None, side_effect=None, return_value=DEFAULT, wraps=None, name=None, spec_set=None, unsafe=False, **kwargs)
   ...
   * _unsafe_: By default if any attribute starts with _assert_ or
     _assret_ will raise an "AttributeError". Passing "unsafe=True"
   ...
   * _name_: If the mock has a name then it will be used in the repr
   ...
   reset_mock(*, return_value=False, side_effect=False)
      ...
      Note:
        ...
        _return_value_, and "side_effect" are keyword only argument.
...
unittest.mock.patch(target, new=DEFAULT, spec=None, create=False, spec_set=None, autospec=None, new_callable=None, **kwargs)
   ...
   to the "Mock" (or _new_callable_) on construction.
