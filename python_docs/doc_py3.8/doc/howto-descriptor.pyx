Python 3.8.20
*howto-descriptor.pyx*                        Last change: 2025 Dec 20
...
Python convention, the instance reference is called _self_ but may be
called _this_ or any other variable name.
