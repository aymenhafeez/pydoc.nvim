...
"lib/python_X.Y_/site-packages" (on Unix and Macintosh).  For each of
...
site.USER_SITE
   ...
   framework Mac OS X builds, "~/Library/Python/_X.Y_/lib/python/site-
...
site.USER_BASE
   ...
   "~/Library/Python/_X.Y_" for Mac framework builds, and
