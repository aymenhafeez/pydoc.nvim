...
<
   ...
   from_float(f)
      ...
      Note _Decimal.from_float(0.1)_ is not the same as
      _Decimal(‘0.1’)_. Since 0.1 is not exactly representable in
      binary floating point, the value is stored as the nearest
      representable value which is _0x1.999999999999ap-4_.  That
      equivalent value in decimal is
      _0.1000000000000000055511151231257827021181583404541015625_.
