...
class socketserver.TCPServer(server_address, RequestHandlerClass, bind_and_activate=True)
   ...
   _bind_and_activate_ is true, the constructor automatically attempts
...
class socketserver.BaseServer(server_address, RequestHandlerClass)
   ...
   serve_forever(poll_interval=0.5)
      ...
      for shutdown every _poll_interval_ seconds. Ignores the
   ...
   get_request()
      ...
      containing the _new_ socket object to be used to communicate
   ...
   Changed in version 3.6: Support for the _context manager_ protocol
...
class socketserver.DatagramRequestHandler
   ...
   data to the client. The "rfile" attributes support the
   "io.BufferedIOBase" readable interface, and "wfile" attributes
   support the "io.BufferedIOBase" writable interface.
