...
class pkgutil.ImpImporter(dirname=None)
   ...
   **PEP 302** Finder that wraps Python’s “classic” import algorithm.
   ...
   If _dirname_ is a string, a **PEP 302** finder is created that
   searches that directory.  If _dirname_ is "None", a **PEP 302**
...
class pkgutil.ImpLoader(fullname, file, filename, etc)
   ...
   _Loader_ that wraps Python’s “classic” import algorithm.
