Python 3.10.19
*telnetlib.pyx*                               Last change: 2025 Dec 20
...
Deprecated since version 3.11: The "telnetlib" module is deprecated
...
class telnetlib.Telnet(host=None, port=0[, timeout])
   ...
   constructor returns.  The optional _timeout_ parameter specifies a
...
Telnet.read_until(expected, timeout=None)
   ...
   Read until a given byte string, _expected_, is encountered or until
...
Telnet.expect(list, timeout=None)
   ...
   _data_ is the bytes received so far (may be empty bytes if a
   timeout happened).
