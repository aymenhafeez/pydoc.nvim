...
TarFile.extractall(path='.', members=None, *, numeric_owner=False, filter=None)
   ...
   The _filter_ argument, which was added in Python 3.10.12, specifies
   ...
   Changed in version 3.10.12: Added the _filter_ parameter.
...
Changed in version 3.10.12: Added "replace()" and handling of "None".
...
TarInfo.mtime: int | float
   ...
   Changed in version 3.10.12: Can be set to "None" for "extract()"
