Python 3.10.19
*xdrlib.pyx*                                  Last change: 2025 Dec 20
...
Deprecated since version 3.11: The "xdrlib" module is deprecated (see
**PEP 594** for details).
...
Packer.pack_farray(n, array, pack_item)
   ...
   _n_.  As above, _pack_item_ is the function used to pack each
   element.
