...
random.randrange(start, stop[, step])
   ...
   Deprecated since version 3.10: The exception raised for non-
   integral values such as "randrange(10.5)" or "randrange('10')" will
...
random.gauss(mu, sigma)
   ...
   Normal distribution, also called the Gaussian distribution.  _mu_
   is the mean, and _sigma_ is the standard deviation.  This is
