...
@dataclasses.dataclass(*, init=True, repr=True, eq=True, order=False, unsafe_hash=False, frozen=False, match_args=True, kw_only=False, slots=False)
   ...
   This function is a _decorator_ that is used to add generated
   _special method_s to classes, as described below.

   The "dataclass()" decorator examines the class to find "field"s.  A
   "field" is defined as a class variable that has a _type
   annotation_.  With two exceptions described below, nothing in
...
<
   ...
   * "unsafe_hash": If "False" (the default), a "__hash__()" method is
     ...
     "None", then "dataclass()" _may_ add an implicit "__hash__()"
   ...
   * "kw_only": If true (the default value is "False"), then all
     ...
     keyword-only, then the only affect is that the "__init__()"
...
class dataclasses.Field
   ...
   object directly.  Its documented attributes are:
      ...
      * "default", "default_factory", "init", "repr", "hash",
        ...
        meaning and values as they do in the "field()" function.
...
dataclasses.make_dataclass(cls_name, fields, *, bases=(), namespace=None, init=True, repr=True, eq=True, order=False, unsafe_hash=False, frozen=False, match_args=True, kw_only=False, slots=False)
   ...
   "unsafe_hash", "frozen", "match_args", "kw_only", and  "slots" have
...
<
   ...
   raise a "TypeError" if it detects a default parameter of type
   "list", "dict", or "set". This is a partial solution, but it does
