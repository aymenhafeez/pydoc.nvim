...
the program needs. Sometimes “top-level code” is called an _entry
point_ to the application.
...
See also:
  ...
  See "zipapp" for how to run applications packaged as _.zip_ files.
...
environment’s scope (_namespace_) by importing the "__main__" module.
