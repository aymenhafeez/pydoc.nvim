...
====================================================================
   ...
   as of Python 3.10, "o.__annotations__" is guaranteed to _always_
   work on Python functions, classes, and modules.  If you’re certain
   the object you’re examining is one of these three _specific_
...
===================================================================
   ...
   inadvertently return the annotations dict of a _base class._ As an
   example:
>
      class Base:
          a: int = 3
...
==============================================
   ...
   * If "o" is a callable (but not a class), use "o.__globals__" as
   ...
   string values that specifically _can’t_ be evaluated.  For example:
...
========================
   ...
   section.  This is _not_ true of modules and classes, in any Python
   ...
   annotation is quoted _twice._  For example:
>
