...
class logging.Formatter(fmt=None, datefmt=None, style='%', validate=True, *, defaults=None)
   ...
   Parameters:
      ...
      * **datefmt** (_str_) – A format string for the date/time
      ...
      * **style** (_str_) – Can be one of "'%'", "'{'" or "'$'" and
        ...
        applies to _fmt_ (e.g. "'%(message)s'" versus "'{message}'"),
...
class logging.LoggerAdapter(logger, extra=None, merge_extra=False)
   ...
   (_extra_), and an optional boolean (_merge_extra_) indicating
   whether or not the _extra_ argument of individual log calls should
   be merged with the "LoggerAdapter" extra. The default behavior is
   to ignore the _extra_ argument of individual log calls and only use
