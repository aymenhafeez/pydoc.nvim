...
@dataclasses.dataclass(*, init=True, repr=True, eq=True, order=False, unsafe_hash=False, frozen=False, match_args=True, kw_only=False, slots=False, weakref_slot=False)
   ...
   _special methods_ to classes, as described below.
...
<
   ...
   * _unsafe_hash_: If true, force "dataclasses" to create a
     "__hash__()" method, even though it may not be safe to do so.
     Otherwise, generate a "__hash__()" method according to how _eq_
     and _frozen_ are set. The default value is "False".
   ...
   * _frozen_: If true (the default is "False"), assigning to fields
     ...
     _frozen_ is true, then "TypeError" is raised.
...
dataclasses.make_dataclass(cls_name, fields, *, bases=(), namespace=None, init=True, repr=True, eq=True, order=False, unsafe_hash=False, frozen=False, match_args=True, kw_only=False, slots=False, weakref_slot=False, module=None, decorator=dataclass)
   ...
   The _decorator_ parameter is a callable that will be used to create
