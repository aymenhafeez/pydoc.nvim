...
class bz2.BZ2File(filename, mode='r', *, compresslevel=9)
   ...
   read1(size=-1)
      ...
      Read up to _size_ uncompressed bytes, while trying to avoid
   ...
   _file object_ instead of an actual filename.The "'a'" (append) mode
   ...
   Changed in version 3.9: The _buffering_ parameter has been removed.
   It was ignored and deprecated since Python 3.0. Pass an open file
   object to control how the file is opened.The _compresslevel_
