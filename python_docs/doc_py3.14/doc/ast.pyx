Python 3.14.2
*ast.pyx*                                     Last change: 2025 Dec 20
...
class ast.TypeIgnore(lineno, tag)
   ...
   A "# type: ignore" comment located at _lineno_. _tag_ is the
...
<
   Note:
     ...
     "TypeIgnore" nodes are not generated when the _type_comments_
...
ast.dump(node, annotate_fields=True, include_attributes=False, *, indent=None, show_empty=False)
   ...
   If _show_empty_ is false (the default), optional empty lists will
...
ast.PyCF_OPTIMIZED_AST
   ...
   The returned AST is optimized according to the _optimize_ argument
...
ast.compare(a, b, /, *, compare_attributes=False)
   ...
   _compare_attributes_ affects whether AST attributes are considered
   in the comparison. If _compare_attributes_ is "False" (default),
