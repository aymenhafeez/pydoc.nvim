Python 3.14.2
*string.templatelib.pyx*                      Last change: 2025 Dec 20
...
(in curly brackets) parts of a string _before_ they are combined.
...
class string.templatelib.Interpolation
   ...
   conversion: Literal['a', 'r', 's'] | None
      ...
      Note:
        ...
        _processes_ the "Template" will decide how to interpret and
   ...
   format_spec: str
      ...
      Note:
        ...
        behavior with t-strings is that code that _processes_ the
...
string.templatelib.convert(obj, /, conversion)
   ...
   object _obj_. This is frequently useful for custom template string
   processing logic.
