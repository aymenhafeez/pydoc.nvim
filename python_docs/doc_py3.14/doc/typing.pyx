...
Note:
  ...
  _equivalent_ to one another. Doing "type Alias = Original" will make
  the static type checker treat "Alias" as being _exactly equivalent_
...
typing.TypeIs
   ...
   "TypeIs" aims to benefit _type narrowing_ – a technique used by
...
<
   ...
   evaluate_bound()
      ...
      An _evaluate function_ corresponding to the "__bound__"
   ...
   evaluate_constraints()
      ...
      An _evaluate function_ corresponding to the "__constraints__"
      attribute. When called directly, this method supports only the
   ...
   evaluate_default()
      ...
      An _evaluate function_ corresponding to the "__default__"
      attribute. When called directly, this method supports only the
      "VALUE" format, which is equivalent to accessing the
...
<
   evaluate_value()
      ...
      An _evaluate function_ corresponding to the "__value__"
      attribute. When called directly, this method supports only the
...
<
   ...
   _closure variable_) in methods of "NamedTuple" subclasses is
...
typing.get_type_hints(obj, globalns=None, localns=None, include_extras=False)
   ...
   * The function recursively replaces all occurrences of
     ...
     "ReadOnly[T]" with "T", unless _include_extras_ is set to "True"
...
typing.evaluate_forward_ref(forward_ref, *, owner=None, globals=None, locals=None, type_params=None, format=annotationlib.Format.VALUE)
   ...
   Evaluate an "annotationlib.ForwardRef" as a _type hint_.
   ...
   the meaning of the _owner_, _globals_, _locals_, _type_params_, and
   _format_ parameters.
...
+---------------------------+---------------------------+---------------------------+---------------------------+
| "@typing.no_type_check_de | 3.13                      | 3.15                      | gh-106309                 |
| corator"                  |                           |                           |                           |
+---------------------------+---------------------------+---------------------------+---------------------------+
