Python 3.14.2
*getopt.pyx*                                  Last change: 2025 Dec 20
...
getopt.getopt(args, shortopts, longopts=[])
   ...
   running program. Typically, this means "sys.argv[1:]". _shortopts_
   ...
   _longopts_, if specified, must be a list of strings with the names
   ...
   only long options, _shortopts_ should be an empty string.  Long
   ...
   accepted options.  For example, if _longopts_ is "['foo', 'frob']",
