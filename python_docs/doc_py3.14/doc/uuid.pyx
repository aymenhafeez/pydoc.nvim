...
<
   ...
   according to **RFC 9562**, overriding bits in the given _hex_,
...
uuid.uuid1(node=None, clock_seq=None)
   ...
   When _node_ is not specified, "getnode()" is used to obtain the
   hardware address as a 48-bit positive integer. When a sequence
   number _clock_seq_ is not specified, a pseudo-random 14-bit
   positive integer is generated.

   If _node_ or _clock_seq_ exceed their expected bit count, only
...
uuid.uuid8(a=None, b=None, c=None)
   ...
   When specified, the parameters _a_, _b_ and _c_ are expected to be
   ...
   By default, _a_, _b_ and _c_ are not generated by a
