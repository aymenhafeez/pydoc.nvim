...
<
   ...
   Changed in version 3.14: Added the _eager_start_ parameter by
   passing on all _kwargs_.
...
class asyncio.TaskGroup
   ...
   create_task(coro, *, name=None, context=None, eager_start=None, **kwargs)
      ...
      Changed in version 3.14: Passes on all _kwargs_ to
      "loop.create_task()"
...
asyncio.as_completed(aws, *, timeout=None)
   ...
   Run awaitable objects in the _aws_ iterable concurrently. The
   ...
   _asynchronous iterator_ or a plain _iterator_. When asynchronous
...
<
   ...
   _asynchronous iterator_ or as a plain _iterator_ (previously it was
...
class asyncio.Task(coro, *, loop=None, name=None, context=None, eager_start=False)
   ...
   cancel(msg=None)
      ...
      If the Task is already _done_ or _cancelled_, return "False",
