...
sqlite3.connect(database, timeout=5.0, detect_types=0, isolation_level='DEFERRED', check_same_thread=True, factory=sqlite3.Connection, cached_statements=128, uri=False, *, autocommit=sqlite3.LEGACY_TRANSACTION_CONTROL)
   ...
   _timeout_, _detect_types_, _isolation_level_, _check_same_thread_,
   _factory_, _cached_statements_, and _uri_ is deprecated. They will
...
class sqlite3.Connection
   ...
   blobopen(table, column, rowid, /, *, readonly=False, name='main')
      ...
      Parameters:
         ...
         * **rowid** (_int_) – The row id where the blob is located.
...
>
         ...
         >>> con.close()
<
      Changed in version 3.13: Passing _name_, _narg_, and _func_ as
...
>
         ...
         con.close()
<
      Changed in version 3.13: Passing _name_, _n_arg_, and
      _aggregate_class_ as keyword arguments is deprecated. These
...
<
   ...
   set_authorizer(authorizer_callback)
      ...
      Changed in version 3.13: Passing _authorizer_callback_ as a
   ...
   set_progress_handler(progress_handler, n)
      ...
      Changed in version 3.13: Passing _progress_handler_ as a keyword
   ...
   set_trace_callback(trace_callback)
      ...
      Changed in version 3.13: Passing _trace_callback_ as a keyword
      argument is deprecated. The parameter will become positional-
      only in Python 3.15.
...
<
   load_extension(path, /, *, entrypoint=None)
      ...
      Parameters:
         * **path** (_str_) – The path to the SQLite extension.

         * **entrypoint** (_str__ | __None_) – Entry point name. If
   ...
   iterdump(*, filter=None)
      ...
      Parameters:
         **filter** (_str__ | __None_) – An optional "LIKE" pattern
...
<
   ...
   getconfig(op, /)
      ...
      Parameters:
         **op** (_int_) – A SQLITE_DBCONFIG code.
   ...
   setconfig(op, enable=True, /)
      ...
      Parameters:
         ...
         * **enable** (_bool_) – "True" if the configuration option
...
class sqlite3.Cursor
   ...
   execute(sql, parameters=(), /)
      ...
      Raises:
         **ProgrammingError** – When _sql_ contains more than one SQL
         statement. When named placeholders are used and _parameters_
         is a sequence instead of a "dict".

      If "autocommit" is "LEGACY_TRANSACTION_CONTROL",
      "isolation_level" is not "None", _sql_ is an "INSERT", "UPDATE",
      ...
      placeholders are used and _parameters_ is a sequence instead of
      a "dict".
   ...
   executemany(sql, parameters, /)
      ...
      Raises:
         **ProgrammingError** – When _sql_ contains more than one SQL
         ...
         are used and the items in _parameters_ are sequences instead
         of "dict"s.
...
<
      ...
      Changed in version 3.14: "ProgrammingError" is emitted if named
      placeholders are used and the items in _parameters_ are
      sequences instead of "dict"s.

   executescript(sql_script, /)

      Execute the SQL statements in _sql_script_. If the "autocommit"
...
<
   ...
   fetchmany(size=cursor.arraysize)
      ...
      Changed in version 3.14.1: Negative _size_ values are rejected
...
named style, _parameters_ must be an instance of a "dict" (or a
...
using the _autocommit_ parameter of "connect()".

It is suggested to set _autocommit_ to "False", which implies **PEP
...
Set _autocommit_ to "True" to enable SQLite’s autocommit mode. In this
...
Set _autocommit_ to "LEGACY_TRANSACTION_CONTROL" to leave transaction
