...
Tabify Region
   Turn _leading_ stretches of spaces into tabs. (Note: We recommend
...
Run… Customized
   ...
   _Command Line Arguments_ extend "sys.argv" as if passed on a
...
the _Python Shell window_ subsection below.
...
an _accessible_ function.  A function name expression may include dots
...
a standard library module, such as _random.py_ and _tkinter.py_. When
