...
class asyncio.StreamReader
   ...
   async readuntil(separator=b'\n')
      ...
      The _separator_ may also be a tuple of separators. In this case
      ...
      Changed in version 3.13: The _separator_ parameter may now be a
      "tuple" of separators.
...
class asyncio.StreamWriter
   ...
   write(data)
      ...
      The _data_ buffer should be a bytes, bytearray, or C-contiguous
