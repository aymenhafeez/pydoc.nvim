Python 3.14.2
*howto-a-conceptual-overview-of-asyncio.pyx*  Last change: 2025 Dec 20
...
pool and invoke it. You can _roughly_ think of the collection of jobs
...
functionality of _generators_ and _generator functions_. Recall, a
...
_might_ be garbage collected before the event loop invokes it. Later
...
note that this asynchronous sleep will sleep _at least_ three seconds,
