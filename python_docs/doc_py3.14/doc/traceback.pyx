...
traceback.print_tb(tb, limit=None, file=None)
   ...
   Note:
     ...
     The meaning of the _limit_ parameter is different than the
     meaning of "sys.tracebacklimit". A negative _limit_ value
     corresponds to a positive value of "sys.tracebacklimit", whereas
     the behaviour of a positive _limit_ value cannot be achieved with
     "sys.tracebacklimit".
...
traceback.print_list(extracted_list, file=None)
   ...
   _file_ is "None", the output is written to "sys.stderr".
...
traceback.format_exception_only(exc, /, [value, ]*, show_group=False)
   ...
   When _show_group_ is "True", and the exception is an instance of
...
class traceback.TracebackException(exc_type, exc_value, exc_traceback, *, limit=None, lookup_lines=True, capture_locals=False, compact=False, max_group_width=15, max_group_depth=10)
   ...
   _lookup_lines_ and _capture_locals_ are as for the "StackSummary"
   class.
   ...
   format_exception_only(*, show_group=False)
      ...
      When _show_group_ is "False", the generator emits the
...
class traceback.StackSummary
   ...
   classmethod extract(frame_gen, *, limit=None, lookup_lines=True, capture_locals=False)
      ...
      local variable (when _capture_locals_ is "True") are no longer
