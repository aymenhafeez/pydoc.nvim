...
class gzip.GzipFile(filename=None, mode=None, compresslevel=9, fileobj=None, mtime=None)
   ...
   The optional _mtime_ argument is the timestamp requested by gzip.
   The time is in Unix format, i.e., seconds since 00:00:00 UTC,
   January 1, 1970. If _mtime_ is omitted or "None", the current time
   is used. Use _mtime_ = 0 to generate a compressed stream that does
...
gzip.compress(data, compresslevel=9, *, mtime=0)
   ...
   as in the "GzipFile" constructor above, but _mtime_ defaults to 0
   ...
   Changed in version 3.14: The _mtime_ parameter now defaults to 0
   for reproducible output. For the previous behaviour of using the
   current time, pass "None" to _mtime_.
