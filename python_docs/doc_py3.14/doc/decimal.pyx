...
class decimal.Context(prec=None, rounding=None, Emin=None, Emax=None, capitals=None, clamp=None, flags=None, traps=None)
   ...
   Emax
      ...
      _Emin_ must be in the range ["MIN_EMIN", "0"], _Emax_ in the
      range ["0", "MAX_EMAX"].
   ...
   clamp
      ...
      prec + 1". If _clamp_ is "0" then a weaker condition holds: the
...
object when called and use the default values from _DefaultContext_.
...
throughout the application, directly modify the _DefaultContext_
object. This should be done _before_ any threads are started so that
