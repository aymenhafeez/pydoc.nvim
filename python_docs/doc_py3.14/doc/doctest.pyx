...
doctest.testfile(filename, module_relative=True, name=None, package=None, globs=None, verbose=None, report=True, optionflags=0, extraglobs=None, raise_on_error=False, parser=DocTestParser(), encoding=None)
   ...
   * If _module_relative_ is "False", then _filename_ specifies an OS-
   ...
   Optional argument _optionflags_ (default value "0") takes the
...
doctest.DocFileSuite(*paths, module_relative=True, package=None, setUp=None, tearDown=None, globs=None, optionflags=0, parser=DocTestParser(), encoding=None)
   ...
   * If _module_relative_ is "False", then each filename in _paths_
   ...
   _setUp_ function will be passed a "DocTest" object.  The _setUp_
   ...
   _tearDown_ function can access the test globals as the "globs"
...
doctest.DocTestSuite(module=None, globs=None, extraglobs=None, test_finder=None, setUp=None, tearDown=None, optionflags=0, checker=None)
   ...
   Optional argument _globs_ is a dictionary containing the initial
   global variables for the tests.  A new copy of this dictionary is
   created for each test.  By default, _globs_ is the module’s
   "__dict__".
...
class doctest.DocTestFinder(verbose=False, parser=DocTestParser(), recurse=True, exclude_empty=True)
   ...
   find(obj[, name][, module][, globs][, extraglobs])
      ...
      * To help find the line number of the object within its file.
      ...
      otherwise. If _extraglobs_ is not specified, then it defaults to
      "{}".
...
class doctest.DocTestRunner(checker=None, verbose=None, optionflags=0)
   ...
   run(test, compileflags=None, out=None, clear_globs=True)
      ...
      results using the writer function _out_. Return a "TestResults"
      instance.
