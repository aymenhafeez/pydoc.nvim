...
xml.etree.ElementTree.iterparse(source, events=None, parser=None)
   ...
   as a target. Returns an _iterator_ providing "(event, elem)" pairs;
   it has a "root" attribute that references the root element of the
   resulting XML tree once _source_ is fully read. The iterator has
   the "close()" method that closes the internal file object if
   _source_ is a filename.
...
xml.etree.ElementTree.tostring(element, encoding='us-ascii', method='xml', *, xml_declaration=None, default_namespace=None, short_empty_elements=True)
   ...
   Changed in version 3.8: Added the _xml_declaration_ and
   _default_namespace_ parameters.
...
class xml.etree.ElementTree.ElementTree(element=None, file=None)
   ...
   write(file, encoding='us-ascii', xml_declaration=None, default_namespace=None, method='xml', *, short_empty_elements=True)
      ...
      Changed in version 3.4: Added the _short_empty_elements_
      parameter.
...
class xml.etree.ElementTree.TreeBuilder(element_factory=None, *, comment_factory=None, pi_factory=None, insert_comments=False, insert_pis=False)
   ...
   pi(target, text)
      ...
      Creates a process instruction with the given _target_ name and
