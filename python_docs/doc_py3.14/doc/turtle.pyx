...
Starting with Python 3.14, you can use the "fill()" _context manager_
...
turtle.bgcolor(r, g, b, /)
   ...
   "bgcolor(colorstring)"
      Set the background color to _colorstring_, which is a Tk color
      specification string, such as ""red"", ""yellow"", or
      ""#33cc8c"".

   "bgcolor((r, g, b))"
      Set the background color to the RGB color represented by the
      tuple of _r_, _g_, and _b_. Each of _r_, _g_, and _b_ must be in
      the range 0..colormode, where colormode is either 1.0 or 255
      (see "colormode()").

   "bgcolor(r, g, b)"
      Set the background color to the RGB color represented by _r_,
      _g_, and _b_.  Each of _r_, _g_, and _b_ must be in the range
      0..colormode.
>
...
turtle.addshape(name, shape=None)
   ...
   1. _name_ is the name of an image file (PNG, GIF, PGM, and PPM) and
      _shape_ is "None": Install the corresponding image shape.
>
...
<
   ...
   2. _name_ is an arbitrary string and _shape_ is the name of an
...
<
   ...
   3. _name_ is an arbitrary string and _shape_ is a tuple of pairs of
      coordinates: Install the corresponding polygon shape.
>
         >>> screen.register_shape("triangle", ((5,-3), (0,5), (-5,-3)))
<
   4. _name_ is an arbitrary string and _shape_ is a (compound)
