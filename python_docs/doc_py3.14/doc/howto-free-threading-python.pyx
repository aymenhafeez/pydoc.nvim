Python 3.14.2
*howto-free-threading-python.pyx*             Last change: 2025 Dec 20

Python support for free threading
*********************************

Starting with the 3.13 release, CPython has support for a build of
Python called _free threading_ where the _global interpreter lock_
...
Some third-party packages, in particular ones with an _extension
module_, may not be ready for use in a free-threaded build, and will
re-enable the _GIL_.
...
In the free-threaded build, some objects are _immortal_. Immortal
