...
curses.assume_default_colors(fg, bg, /)
   ...
   * Assign terminal default foreground/background colors to color
     ...
     pair _x_ as red on default background and "init_pair(x, -1,
     COLOR_BLUE)" will initialize pair _x_ as default foreground on
     blue.
...
curses.init_pair(pair_number, fg, bg)
   ...
   "assume_default_colors()"). The value of _fg_ and _bg_ arguments
...
window.attron(attr)
   ...
   Add attribute _attr_ to the “background” set applied to all writes
...
window.getstr(y, x, n)
   ...
   capacity. The maximum value for _n_ is 2047.

   Changed in version 3.14: The maximum value for _n_ was increased
   from 1023 to 2047.
