...
class string.Formatter
   ...
   parse(format_string)
      ...
      _field_name_, _format_spec_ and _conversion_ will be "None". The
      value of _field_name_ is unmodified and auto-numbering of non-
      numbered positional fields is done by "vformat()".

   get_field(field_name, args, kwargs)

      Given _field_name_, convert it to an object to be formatted.
      Auto-numbering of _field_name_ returned from "parse()" is done
...
The _grouping_ option after _width_ and _precision_ fields specifies a
...
Changed in version 3.14: Support the _grouping_ option for the
fractional part.
