...
class symtable.Function
   ...
   get_frees()
      ...
      Return a tuple containing names of _free (closure) variables_ in
      this function.
...
class symtable.Symbol
   ...
   is_free_class()
      ...
      Return _True_ if a class-scoped symbol is free from the
...
<
      ...
      latter to return _1_ at runtime and not _2_.
