Python 3.14.2
*__future__.pyx*                              Last change: 2025 Dec 20
...
|===========================|===========================|===========================|===========================|
| __future__.nested_scopes  | 2.1.0b1                   | 2.2                       | **PEP 227**: _Statically  |
|                           |                           |                           | Nested Scopes_            |
+---------------------------+---------------------------+---------------------------+---------------------------+
| __future__.generators     | 2.2.0a1                   | 2.3                       | **PEP 255**: _Simple      |
|                           |                           |                           | Generators_               |
+---------------------------+---------------------------+---------------------------+---------------------------+
| __future__.division       | 2.2.0a2                   | 3.0                       | **PEP 238**: _Changing    |
|                           |                           |                           | the Division Operator_    |
+---------------------------+---------------------------+---------------------------+---------------------------+
| __future__.absolute_impor | 2.5.0a1                   | 3.0                       | **PEP 328**: _Imports:    |
| t                         |                           |                           | Multi-Line and            |
|                           |                           |                           | Absolute/Relative_        |
+---------------------------+---------------------------+---------------------------+---------------------------+
| __future__.with_statement | 2.5.0a1                   | 2.6                       | **PEP 343**: _The “with”  |
|                           |                           |                           | Statement_                |
+---------------------------+---------------------------+---------------------------+---------------------------+
| __future__.print_function | 2.6.0a2                   | 3.0                       | **PEP 3105**: _Make print |
|                           |                           |                           | a function_               |
+---------------------------+---------------------------+---------------------------+---------------------------+
| __future__.unicode_litera | 2.6.0a2                   | 3.0                       | **PEP 3112**: _Bytes      |
| ls                        |                           |                           | literals in Python 3000_  |
+---------------------------+---------------------------+---------------------------+---------------------------+
| __future__.generator_stop | 3.5.0b1                   | 3.7                       | **PEP 479**:              |
|                           |                           |                           | _StopIteration handling   |
|                           |                           |                           | inside generators_        |
+---------------------------+---------------------------+---------------------------+---------------------------+
| __future__.annotations    | 3.7.0b1                   | Never [1]                 | **PEP 563**: _Postponed   |
|                           |                           |                           | evaluation of             |
|                           |                           |                           | annotations_, **PEP       |
|                           |                           |                           | 649**: _Deferred          |
