...
<
      If “vsapi” is used as the value of _etype_, "element_create()"
      ...
      _args_ is expected to contain the Visual Styles class and part
      ...
      Styles API state value. _kw_ may have the following options:

      padding=padding
         Specify the element’s interior padding. _padding_ is a list
      ...
      margins=padding
         Specifies the elements exterior padding. _padding_ is a list
         of up to four integers specifying the left, top, right and
      ...
      width=width
         ...
         _height_ should also be set. The _width_ and _height_ options
         cannot be mixed with the _padding_ or _margins_ options.
