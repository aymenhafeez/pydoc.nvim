...
json.load(fp, *, cls=None, object_hook=None, parse_float=None, parse_int=None, parse_constant=None, object_pairs_hook=None, **kw)
   ...
   Parameters:
      ...
      * **object_pairs_hook** (_callable_ | None) – If set, a function
        that is called with the result of any JSON object literal
        decoded with an ordered list of pairs. The return value of
        this function will be used instead of the "dict". This feature
        can be used to implement custom decoders. If _object_hook_ is
        also set, _object_pairs_hook_ takes priority. Default "None".
...
json.loads(s, *, cls=None, object_hook=None, parse_float=None, parse_int=None, parse_constant=None, object_pairs_hook=None, **kw)
   ...
   Changed in version 3.9: The keyword argument _encoding_ has been
   removed.
...
class json.JSONEncoder(*, skipkeys=False, ensure_ascii=True, check_circular=True, allow_nan=True, sort_keys=False, indent=None, separators=None, default=None)
   ...
   escaped. If _ensure_ascii_ is false, all characters will be output
