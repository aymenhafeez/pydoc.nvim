...
glob.translate(pathname, *, recursive=False, include_hidden=False, seps=None)
   ...
   If _recursive_ is true, the pattern segment “"**"” will match any
   number of path segments.

   If _include_hidden_ is true, wildcards can match path segments that
   start with a dot (".").

   A sequence of path separators may be supplied to the _seps_
