...
"itms-services" scheme is always removed on iOS; on macOS, it _may_ be
...
urllib.parse.parse_qs(qs, keep_blank_values=False, strict_parsing=False, encoding='utf-8', errors='replace', max_num_fields=None, separator='&')
   ...
   Changed in version 3.10: Added _separator_ parameter with the
...
urllib.parse.quote(string, safe='/', encoding=None, errors=None)
   ...
   Replace special characters in _string_ using the "%_xx_" escape.
...
urllib.parse.unquote(string, encoding='utf-8', errors='replace')
   ...
   Replace "%_xx_" escapes with their single-character equivalent. The
...
urllib.parse.unquote_to_bytes(string)
   ...
   Replace "%_xx_" escapes with their single-octet equivalent, and
