...
build of Python called _free threading_ where the _global interpreter
lock_ (GIL) is disabled.  Free-threaded execution allows for full
...
_immortal_. Immortal objects are not deallocated and have reference
...
* _module_ objects and their dictionaries
