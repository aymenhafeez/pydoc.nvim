...
class fractions.Fraction(string)
   ...
   _denominator_ is zero, it raises a "ZeroDivisionError". The second
   version requires that _other_fraction_ is an instance of
   ...
   to 11/10, and so "Fraction(1.1)" does _not_ return "Fraction(11,
