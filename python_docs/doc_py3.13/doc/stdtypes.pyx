...
allows embedding arbitrary Python expressions within _replacement
fields_, which are delimited by curly brackets ("{}"). These
...
>
   ...
   'This is a string\non two lines'
<
A single opening curly bracket, "'{'", marks a _replacement field_
