...
class sqlite3.Cursor
   ...
   execute(sql, parameters=(), /)
      ...
      and _parameters_ is a sequence instead of a "dict". Starting
...
<
      ...
      Deprecated since version 3.12, will be removed in version 3.14:
      "DeprecationWarning" is emitted if named placeholders are used
      and the items in _parameters_ are sequences instead of "dict"s.
...
<
   ...
   fetchmany(size=cursor.arraysize)
      ...
      Changed in version 3.13.8: Negative _size_ values are rejected
   ...
   arraysize
      ...
      Changed in version 3.13.8: Negative values are rejected by
      raising "ValueError".
