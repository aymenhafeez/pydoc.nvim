...
There are two variants of the interactive _REPL_.  The classic basic
...
with neither output nor the _>>>_ and _…_ prompts. "F3" enters “paste
mode”, which makes pasting larger blocks of code easier. Press "F3" to
