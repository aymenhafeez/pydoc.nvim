...
<
The call to "basicConfig()" should come _before_ any calls to a
...
Note:
  ...
  It is strongly advised that you _do not log to the root logger_ in
...
15. "NullHandler" instances do nothing with error messages. They are
    ...
    avoid the ‘No handlers could be found for logger _XXX_’ message
