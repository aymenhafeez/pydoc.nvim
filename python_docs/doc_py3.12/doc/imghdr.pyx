...
imghdr.what(file, h=None)
   ...
   Test the image data contained in the file named _file_ and return a
   string describing the image type.  If _h_ is provided, the _file_
   argument is ignored and _h_ is assumed to contain the byte stream
   to test.
