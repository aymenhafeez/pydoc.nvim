...
class importlib.resources.abc.Traversable
   ...
   abstractmethod joinpath(*pathsegments)
      ...
      Traverse directories according to _pathsegments_ and return the
      result as "Traversable".

      Each _pathsegments_ argument may contain multiple names
...
<
      ...
      _pathsegments_, and these segments may contain forward slashes
      as path separators. Previously, only a single _child_ argument
      was accepted.
